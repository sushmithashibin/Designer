 ...
 */
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    //Overwrite language-specific strings. This way we'll never have missing translations - no more "language string failed to load"!  // 1964 line comment
    $l = true;
  ...
  */
  ...
  private function Lang($key) {
    ...
    if(isset($this->language[$key])) {
     ...
     // return 'Language string failed to load: ' . $key;  // comment the line working area part  
    }
  }
