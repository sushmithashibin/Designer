	...
	<div class="col-sm-8">
		<div class="" style="    border: 2px solid #eee;padding: 30px 20px;">
			<div class="row">
				...
				<div class="col-sm-4"><?php if(isset($adreply)){?>

					<a href="<?php echo base_url('index.php/designerctrl/de_deleteadmsg/'.$id);?>" style="float: right;"><span class="fa fa-trash" style="padding: 10px;" ></span></a><?php } else {
						?>
						<a href="<?php echo base_url('index.php/designerctrl/de_deletecumsg/'.$id);?>" style="float: right;"><span class="fa fa-trash" style="padding: 10px;" ></span></a>
			<?php 		} ?>
