...
<head>
	<title>File Upload widget a Flat Responsive Widget Template :: w3layouts</title>
        <link rel="stylesheet" href="../templates/upload/css/style.css">
        <link href='../templates/upload///fonts.googleapis.com/css?family=Open+Sans:400,300italic,300,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
        <link rel="icon" href="<?=base_url()?>templates/dgrid/images/logo1.png" type="image/gif">

        <link href='../templates/upload///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
...
<div class="agile-its">
	...
	<p>File Upload widget with multiple file selection, drag&drop support. You can drag & drop files from your desktop on this webpage.</p>
		...
		<div class="clearfix"></div>
                <script src="../templates/upload/js/filedrag.js"></script>
...
<script type="text/javascript" src="../templates/upload/js/jquery.min.js"></script>
