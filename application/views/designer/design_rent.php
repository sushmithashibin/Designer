						...
						<div class="grid-info">
							...
							<div class="lables">
                                                            <p id="pr">Price: <?php echo $value->price;?></p>
                                                             <a href="<?php echo base_url('index.php/designerctrl/rent_delete/'.$id);?>" type="button"  class="glyphicon glyphicon-trash" style="float: right"title="Delete" onclick="return confirm
