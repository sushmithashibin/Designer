...
<td>
   <a href="<?php echo base_url('index.php/designerctrl/de_deliver/'.$ids);?>" type="button" class="btn btn-primary btn-primary" style="background-color: #b75133;">Delivered</a></td>
