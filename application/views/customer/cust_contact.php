...
">
             <div class="row">
               <div class="col-sm-6">
                 <h4 style="padding-bottom: 6px;"><?php echo $value->subject;?></h4>
               </div>
               <div class="col-sm-6">
             ...
             <div class="row">
               <a type="button" href="<?php echo base_url('index.php/designerctrl/cust_addtre/'.$id);?>" class="btn btn-primary" style="float: right;padding: 6px;margin-right: 10px;">more..</a>
             </div>
...
<div class="col-sm-6">
  <div class="" style="padding: 40px;    background-color: #477ba596;">
      <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/designerctrl/cust_send');?>">
    ...
    <div class="form-group">
      <label for="comment" style="color:blue"></label>
...
">
             ...
             <div class="row">
               <div class="col-sm-6">
                 <p style="    color: #030404;"><span><?php echo $value->dname;?></span></p>
                                  <p style=""><?php echo  $value->date;?></p>
               </div>
             ...
             <div class="row">
               <a type="button" href="<?php echo base_url('index.php/designerctrl/cust_demsg/'.$idd);?>" class="btn btn-primary" style="float: right;padding: 6px;margin-right: 10px;">more..</a>
             </div>
  ...
  $('#sel1').change(function()
  {
   ...
   //alert(dname);
    ...
    if(dname=="2")
    {
         ...
         $.ajax({
         type: "POST",
         url:  '<?php echo base_url('index.php/designerctrl/cust_designer')?>',
         data:  'dname='+dname,
         success:
              function(data){
