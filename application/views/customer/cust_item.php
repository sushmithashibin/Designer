			...
			<div class="clear"> </div>
					...
					<div class="title">
						<br><br><br><br>
	                                   ...
	                                   foreach ($item as $value) {
	                                    ...
	                                    ?>
						<h2 style="color:black;font-size: 30px;font-family: Bookman Old Style"><?php echo $value->dname;?></h2>
						<ul>
	                                            <!--
							<li><h4>By:</h4></li>
					...
					<div class="video-details">
						...
						<ul class="other-links">
													<h3 style="font-size: 25px;">Description: <?php echo $value->pdesc;?></h3>
...
<?php
	                                   ...
	                                   foreach ($dress as $value) {
	                                    ...
	                                    ?><br>
								<ul class="other-links">
													<h3 style="font-size: 20px;">Material: <?php echo $value->material;?></h3>

						</ul><br>
						<ul class="other-links">
													<h3 style="font-size: 20px;">Available Sizes: <?php echo $value->size;?></h3>

						</ul><br>
						<ul class="other-links">
													<h3 style="font-size: 20px;">Actual Price: <?php echo $value->price;?></h3>
...
<?php
	                                   foreach ($item as $value) {
	                                    ...
	                                    ?>
						<ul class="other-links">
													<h3 style="font-size: 20px;">Discount Price: <?php echo $value->discount;?></h3>
